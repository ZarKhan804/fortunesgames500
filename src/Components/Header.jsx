...
const gameImage =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROxWbecGgNLmrfOLyL3ZNaBFisAq9tk4lIDXppY-NEtQ&s=10";
        ...
        >
          ...
          <div className="min-w-0">
            <h1 className="whitespace-nowrap text-[20px] font-black leading-tight tracking-tight text-white sm:text-[24px]">
              Fortunes<span className="text-yellow-400">Games500</span>
            </h1>
        ...
        <div className="border-t border-white/10 bg-slate-950 lg:hidden">
          <nav className="mx-auto flex max-w-7xl flex-col px-5 py-2">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={closeMenu}
              className="my-3 flex items-center justify-center gap-2 rounded-xl bg-yellow-400 px-5 py-3.5 text-[15px] font-extrabold text-slate-950 transition hover:bg-yellow-300"
            >
              <Download size={18} strokeWidth={2.5} />
              Download
            </a>
